      ...
      <main className="ml-64 min-h-screen flex flex-col">
        ...
        <header className="h-24 flex items-center justify-between px-12 bg-paper-white/80 backdrop-blur-md sticky top-0 z-30 border-b border-gallery-gold/20">
          ...
          <div className="flex items-center gap-8">
            <button
              className={`bg-primary text-white font-label-caps text-[10px] tracking-widest uppercase px-8 py-3 flex items-center gap-3 relative overlay-hidden group transition-colors ${artworks.some(art => {
